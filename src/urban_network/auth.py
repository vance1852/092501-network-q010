...
PERMISSIONS={"viewer":{"read"},"operator":{"read","measure","work_order","allocate","receipt"},"engineer":{"read","measure","work_order","allocate","analyze","dispatch","receipt","arbitrate"},"quality":{"read","measure","work_order","allocate","analyze","approve","arbitrate"},"admin":{"read","measure","work_order","allocate","analyze","approve","admin","dispatch","receipt","arbitrate"}}
